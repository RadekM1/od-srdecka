  ...
  return (
    <>
      ...
      <div className="flex mb-10 flex-row pb-14 gap-12 font-oldStandard">
        <a
          className="bg-[#061E4C] text-base lg:text-xl hover:bg-white hover:text-[#061E4C] border-[1px] border-[#061E4C]  duration-300 ease-in-out  text-white w-32 py-2 rounded-xl"
          href="#cenik-kotva"
        >
          Ceník
        </a>
