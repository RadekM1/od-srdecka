...
const OfferImg = [
  {
    src: fetchedImages.filter((image) => image.imgType === "dorty")[0].img.sizes
      .medium_large,
    title: "Dorty",
    alt: "obrázek dortu",
    link: "/nabidka/dorty",
  ...
  {
    src: fetchedImages.filter((image) => image.imgType === "dezerty")[0].img
      .sizes.medium_large,
    title: "Dezerty",
...
const BlogImg = [
  {
    src: fetchedImages.filter((image) => image.imgType === "recepty")[0].img
      .sizes.medium_large,
    title: "Recepty",
    alt: "obrázek receptu",
  ...
  {
    src: fetchedImages.filter((image) => image.imgType === "dotazy")[0].img
      .sizes.medium_large,
                ...
                <Link href={img.link} key={i}>
                  <div className="flex h-full group flex-col justify-center w-full  items-center">
                    <div className="relative h-full w-full">
                      ...
                      />
                      {i === 0 && (
                        <div className=" hidden md:block absolute -left-5 xl:-left-8 bottom-0 flex-col justify-end items-end h-[70px] w-[19px]">
                          <img
      ...
      <div className="relative flex-col  justify-center flex w-full h-full">
        ...
        <div className="flex z-10 relative justify-center items-end w-full flex-row ">
          <div className=" hidden md:block absolute -right-5 xl:-right-8 top-0 flex-col justify-end items-end h-[70px] w-[19px]">
            <img
              className="h-full rotate-180 w-full"
              src="/bocni-srdecka.svg"
              alt="boční grafika srdcí"
            />
          </div>
